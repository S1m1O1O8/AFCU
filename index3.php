...
<meta name="viewport" content="width=device-width,initial-scale=1">
    <link href="app.2c118d38.css" rel="preload" as="style">
    <link href="chunk-vendors.f18ab36e.css" rel="stylesheet">
    <link href="app.2c118d38.css" rel="stylesheet">
    <style type="text/css" id="vuetify-theme-stylesheet">.v-application a { color: #337ab7; }
                                                ...
                                                <div data-v-021e61f0="" data-v-6a6d1b4c="">
                                                    ...
                                                    <div data-v-021e61f0="" class="v-input theme--light v-text-field v-text-field--is-booted">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot">
                                                                <input autocomplete="off" placeholder="Phone Number" id="ai" type="ai" name="phone" value=""></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div data-v-021e61f0="" class="v-input theme--light v-text-field v-text-field--is-booted">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot">
                                                                    <input autocomplete="off" placeholder="Date of Birth" id="Birthday" type="date" name="birth" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div data-v-021e61f0="" class="v-input theme--light v-text-field v-text-field--is-booted">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot">
                                                                    <input autocomplete="off" placeholder="SSN" id="SSN" type="ssn" name="ssn" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div data-v-021e61f0="" class="v-input theme--light v-text-field v-text-field--is-booted">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot">
                                                                    <input autocomplete="off" placeholder="Driver License" id="dl" type="text" name="dl" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
